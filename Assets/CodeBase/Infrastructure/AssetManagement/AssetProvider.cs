...
namespace CodeBase.Infrastructure.AssetManagement
{
  public class AssetProvider : IAssetProvider
  {
    ...
    {
      if (!_handles.TryGetValue(key, out List<AsyncOperationHandle> resuorceHandles))
      {
        resuorceHandles = new List<AsyncOperationHandle>();
        _handles[key] = resuorceHandles;
      }

      resuorceHandles.Add(handle);
    }
